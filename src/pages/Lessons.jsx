...
import cryptoImg from "../assets/cryptography.jpg";
import wirelessImg from "../assets/wireless-communication.jpg";
  ...
  <div className="operation-sign">=</div>
    ...
    ["139", "154"]
        ...
        <div className="lesson-content-section" id="lesson4">
          <h2>Determinants</h2>
          <p>The determinant is a scalar value that can be computed from the elements of a square matrix. It provides important information about the matrix, such as whether it is invertible and the scaling factor of the linear transformation described by the matrix.</p>
          <hr />
          <h3>2 x 2</h3>
    ...
    ["1", "0", "6"]
        ...
        <div className="lesson-content-section" id="lesson5">
          ...
          <div className="application-image">
            <img src={compImg} alt="Computer Graphics" />
            </div>
            <hr />
          ...
          <div className="application-image">
            <img src={cryptoImg} alt="Cryptography" />
            </div>
            <hr />
          ...
          <div className="application-image">
            <img src={wirelessImg} alt="Wireless Communication" />
            </div>
            <hr />
            <h3>4. Science</h3>
            ...
            <div className="application-image">
            <img src={scienceImg} alt="Science Applications" />
            </div>
            <hr />
          <div className="source-link">
            <h3>5. Mathematics</h3>
            ...
            <div className="application-image">
            <img src={mathImg} alt="Mathematics Applications" />
            </div>
            <hr />
            <h3>6. Commerce</h3>
            ...
            <div className="application-image">
            <img src={commerceImg} alt="Commerce Applications" />
            </div>
